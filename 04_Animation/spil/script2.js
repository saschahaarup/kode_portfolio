...
function sidenVises() {
  ...
  //windowResize(); Hvad skal der i denne ??
...
function startGame() {
  ...
  // starter timer
  document.querySelector("#time_board").classList.add("drej_timer");
  ...
  good1.classList.add("fald_kf");
  good2.classList.add("fald_kf");
  good3.classList.add("fald_kf");
  good4.classList.add("fald_kf");
  good5.classList.add("fald_kf");
  bad1.classList.add("fald_kf");
  bad2.classList.add("fald_kf");
  bad3.classList.add("fald_kf");
  bad4.classList.add("fald_kf");
  bad5.classList.add("fald_kf");
  ...
  function stopGame() {
    ...
    //Stop timer
    document.querySelector("#time_board").classList.remove("drej_timer");
    document
      .querySelector("#time_board")
